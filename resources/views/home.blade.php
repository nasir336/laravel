...
<div class="slider-active">
    <div class="slider-single-item">
        <img src="fondend/img/slider-img2.jpg" class="img-fluid" alt="no image">
    ...
    <div class="slider-single-item">
        <img src="fondend/img/slider-img2.jpg"  class="img-fluid" alt="">
        <div class="slider-text">
            <h2>Cherner <span>Armchair</span></h2>
            <p>The 1958 moulded plywood armchair by Norman Cherner.</p>
            <a href="#">View now</a>
    ...
    <div class="slider-single-item">
        <img src="fondend/img/slider-img3.jpg" class="img-fluid" alt="">
        <div class="slider-text">
            <h2>Cherner <span>Armchair</span></h2>
            <p>The 1958 moulded plywood armchair by Norman Cherner.</p>
            <a href="#">View now</a>
        ...
        <div class="product-tab">
            <ul class="nav" role="tablist">
                <li class="nav-item  pb-5">
                    <a class="nav-link show active" data-toggle="tab" href="#furniture" role="tab">All</a>
               
                @foreach($category as $value)
                    <li class="nav-item  pb-5">
                    <a class="nav-link"  data-toggle="tab" href="{{ $value->id }}" role="tab">{{$value->name}}</a>
                </li>
                 @endforeach 
                 </li>
            </ul>
...
<div class="product-active owl-carousel nav-style">
    ...
    @if($value->id == $row->cat_id)
    <div class="product-wrapper">
        <div class="product-img">
            <a href="#"> <img src="{{$products->image}}" alt=""></a>
            <a href="#"> <img class="secondary-img" src="fondend/img/product-img/product1.jpg"
                    alt=""></a>
            <span>hot</span>
            <div class="product-action">
                <a href="#"><i class="far fa-eye"></i></a>
...
<div class="banner-img">
    <a href="#"><img class="img-fluid" src="fondend/img/banner-img/banner.jpg" alt=""></a>
</div>
</div>
</div>
<!--Product Area-->
...
<div class="row">
    <div class="brand-active owl-carousel ">
        <div class="single-brand"><a href=""><img src="fondend/img/brand/brand1.jpg" alt="" class=""></a></div>
        <div class="single-brand"><a href=""><img src="fondend/img/brand/brand1.jpg" alt="" class=""></a></div>
        <div class="single-brand"><a href=""><img src="fondend/img/brand/brand1.jpg" alt="" class=""></a></div>
        <div class="single-brand"><a href=""><img src="fondend/img/brand/brand1.jpg" alt="" class=""></a></div>
        <div class="single-brand"><a href=""><img src="fondend/img/brand/brand1.jpg" alt="" class=""></a></div>
