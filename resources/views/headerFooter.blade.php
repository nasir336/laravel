...
<!-- Bootstrap CSS -->
<link rel="stylesheet" href="{{asset('fondend/css/bootstrap.min.css')}}">
<!-- MAIN CSS-->
<link rel="stylesheet" href="{{asset('fondend/css/main.css')}}">
<!--my responsive-->
<link rel="stylesheet" href="{{asset('fondend/css/responsive.css')}}">
<!--- FONT AWESOME -->
<link rel="stylesheet" type="text/css" href="{{asset('fondend/css/all.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('fondend/css/meanmenu.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('fondend/css/slick.css')}}">
<link rel="stylesheet" type="text/css" href="css/slick-theme.css">
<link rel="stylesheet" href="{{asset('fondend/css/nice-select.css')}}">
<!--- awl carousel -->
<link rel="stylesheet" type="text/css" href="{{asset('fondend/css/owl.carousel.min.css')}}">
...
<div class="row">
    ...
    <div class="col-xl-2 col-md-4 col-sm-12 text-center mb-0  my-xl-5 ">
        <div class="">
            <a href="index.html" class="text-center"><img width="175" height="45" src="fondend/img/logo.png"
                    alt=""></a>
        </div>
    </div>
...
<script src="{{asset('fondend/js/jquery-3.4.1.min.js')}}"></script>
<script src="{{asset('fondend/js/popper.min.js')}}"></script>
<script src="{{asset('fondend/js/bootstrap.min.js')}}"></script>
<script src="{{asset('fondend/js/owl.carousel.min.js')}}"></script>
<script src="{{asset('fondend/js/jquery.meanmenu.min.js')}}"></script>
<script src="{{asset('fondend/js/slick.min.js')}}"></script>
<script src="{{asset('fondend/js/jquery.nice-select.min.js')}}"></script>
