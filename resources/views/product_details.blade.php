...
<img class="img-fluid" src="{{asset('fondend/img/pro-det-tab-img/2.jpg')}}" alt="">
</div>
<div class="tab-pane fade" id="img3" role="tabpanel">
<img class="img-fluid" src="{{asset('fondend/img/pro-det-tab-img/3.jpg')}}" alt="">
</div>
</div>
...
<a href="{{ route('product_details',['id'=>$rl_product->id]) }}"> <img src="/{{$rl_product->image}}" alt=""></a>
...
<h3><a href="#">{{$rl_product->product_name}}</a></h3>
<div class="rating">
<i class="fas far fa-star"></i>
<i class="fas far fa-star"></i>
<i class="fas far fa-star"></i>
...
<div class="price">
<span>$ {{$rl_product->buying_price}} </span>
